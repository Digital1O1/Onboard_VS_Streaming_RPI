...
int main()
{
    ...
    fs["visibleToInfraredHomography"] >> visibleToInfraredHomography;
    ...
    cv::imwrite("YenThreshold_On_IR_Frame.PNG", yenThresholdedFrame);
    cv::imwrite("ColoredFrame.PNG", *ColoredFrame);
    cv::imwrite("visibleToIRProjectedFrame.PNG", visibleToIRProjectedFrame);
