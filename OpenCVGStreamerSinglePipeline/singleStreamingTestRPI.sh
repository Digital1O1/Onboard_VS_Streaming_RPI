...
raspivid -t 0 -n -w 640 -h 480 -fps 30 -b 2000000 -o - -cs 1 | gst-launch-1.0  fdsrc ! h264parse ! rtph264pay config-interval=10 pt=96 ! udpsink host=172.17.140.56 port=5001 &
