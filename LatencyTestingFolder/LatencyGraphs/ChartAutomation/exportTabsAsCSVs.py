...
# Load the CSV file
file_path = r"/home/digital101/Onboard_VS_Streaming_RPI/Latency Testing Folder/LatencyGraphs/Book1.csv"
...
for i, category in enumerate(categories):
    ...
    if matches.empty:
        print(f"Category '{category}' not found in DataFrame.")
        continue
...
for i, category in enumerate(categories):
    ...
    bars = axs[i].bar(elements, means, color=colors[:len(elements)])
