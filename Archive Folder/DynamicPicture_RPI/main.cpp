...
int main()
{
    ...
    else
    {
        ...
        std::cout << "[STEP 1] Time elapsed for RPI to OPEN SOCKET : " << socketDuration.count() << " microseconds" << std::endl;
    }
    ...
    else
    {
        ...
        std::cout << "[STEP 3] Time elapsed for RPI to BIND SOCKET : " << bindSocketDuration.count() << " microseconds" << std::endl;
    }
    ...
    std::cout << "[STEP 5] Time elapsed for RPI to capture SINGLE IMAGE : " << captureDuration.count() << " microseconds" << std::endl;

    // Send resolution information
    auto sendImageResolutionStart = std::chrono::high_resolution_clock::now();
    ...
    auto sendImageResolutionStop = std::chrono::high_resolution_clock::now();
    auto imageResolutionDuration = std::chrono::duration_cast<std::chrono::microseconds>(sendImageResolutionStop - sendImageResolutionStart);
    std::cout << "[STEP 7]Time elapsed for RPI TO SEND IMAGE RESOLUTION : " << imageResolutionDuration.count() << " microseconds" << std::endl;
    ...
    else
    {
        ...
        std::cout << "[STEP 9] Time elapsed for RPI to SEND RAW IMAGE DATA TO WINDOWS : " << sendImageDataDuration.count() << " microseconds" << std::endl;
    }
    ...
    else
    {
        ...
        std::cout << "[STEP 16] Time elapsed for RPI to RECIEVE THRESHOLD RESOLUTION FROM WINDOWS : " << recieveResolutionDuration.count() << " microseconds" << std::endl;
    }
    ...
    std::cout << "[STEP 17] Time elapsed for RPI to RECIEVE THRESHOLDED IMAGE DATA FROM WINDOWS : " << thresholdImageDuration.count() << " microseconds" << std::endl;
